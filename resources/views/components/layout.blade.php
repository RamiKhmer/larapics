    ...
    <nav class="navbar navbar-expand-lg navbar-light border-bottom">
        <div class="container-fluid">
            <a class="navbar-brand" href="/">
                <x-icon src="logo.svg" class="d-inline-block align-text-top color-light" width="30" height="24"/>
                      Larapics
            </a>
            <a href="{{ route('images.create') }}" class="btn text-primary">Upload Image</a>
            <div class="d-flex">
